<template>
  <div class="max-w-lg">
    ...
    <p class="text-2xl font-semibold">Execuxion</p>
    <p class="mb-2 mt-1">Version: {{ extensionVersion }}</p>
    <p class="text-gray-600 dark:text-gray-200">
      Execuxion is a no-code/low-code visual workflow builder for social media automation,
      data scraping, and API integration. Create powerful automation workflows with
      an intuitive drag-and-drop interface - no coding required.
    </p>
