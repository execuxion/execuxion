      ...
      <div class="flex-1">
        ...
        >
          <ui-card
            ...
            :key="pkg.id"
            class="group flex flex-col cursor-pointer hover:ring-2 hover:ring-accent dark:hover:ring-gray-200"
          ...
          >
            <div class="flex items-center">
              ...
              <div class="grow" />
              <ui-popover trigger="manual" :model-value="state.openMenuId === pkg.id" @update:model-value="(val) => state.openMenuId = val ? pkg.id : null">
                <template #trigger>
                  <button @click.stop="state.openMenuId = state.openMenuId === pkg.id ? null : pkg.id">
                    <v-remixicon
                      name="riMoreLine"
